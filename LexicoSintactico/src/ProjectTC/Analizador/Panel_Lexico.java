...
public class Panel_Lexico extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        KLimpiar.setkStartColor(new java.awt.Color(0, 255, 102));
    ...
    private void btnAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAbrirActionPerformed
        ...
        try {
            ...
            if (se == 0) {
                ...
                JOptionPane.showMessageDialog(null, "Archio no Seleccionado");
            }
    ...
    public void RedimFull(boolean Redimenzionar){
        ...
        if(Redimenzionar){
            ...
            btnLimpiar.setBounds(0,0,220,44);
            ...
            btnLimpiar.setBounds(0,0,159,44);
